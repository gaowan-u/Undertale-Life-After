...
class MainMenu:
    def __init__(self, screen):
        ...
        for index, item in enumerate(self.menu_items):
            ...
            item_rect = item_text.get_rect(center=(screen_width / 2, screen_height / 2 + index * 80))
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 1 and self.selected_index != -1:
                if self.selected_index == 0: return "start_game"
                elif self.selected_index == 1: return "open_settings"
                elif self.selected_index == 2: return "exit"
