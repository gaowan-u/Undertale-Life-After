...
def gameplay(events):
    ...
    gameplay_surface.blit(IMAGE_ASSETS['cropped_button_1'], (1400, screen_height - 240))
    gameplay_surface.blit(IMAGE_ASSETS['cropped_button_2'], (1544, screen_height - 320))
    gameplay_surface.blit(IMAGE_ASSETS['cropped_button_3'], (1688, screen_height - 400))
